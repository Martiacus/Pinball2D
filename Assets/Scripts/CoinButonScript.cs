...
public class CoinButonScript : MonoBehaviour {
    ...
    void OnClick()
    {
        ...
        {
            controller.UpdateCoinSprite(integer - 1);
            SaveGameScript();
    ...
    private void SetShopSpriteToCurrent(int integer)
    {
        ...
        GameObject coin = shopscreen.transform.Find("Coin").gameObject;

        coin.GetComponent<Image>().sprite = controller.coinSprites[integer].sprites[0];
    }
    ...
    {
        if (controller.boughtCoin[integer - 1])
        {
            return true;
        }
        else return false;
    ...
    private void BuyItem(int integer)
    {
        ...
        controller.UpdateCoinSprite(integer - 1);
        controller.boughtCoin[integer - 1] = true;
...
/// <summary>
/// Saves our bought item to save class
/// </summary>
/// <param name="id">id of the object saved</param>
    ...
    private void SaveGameScript()
    {
        ...
        save.SaveCoin(controller.coinID);
